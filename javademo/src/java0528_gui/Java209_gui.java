...
class LayoutTest extends Frame {
	Button northBtn, centerBtn, southBtn, eastBtn, westBtn; //버튼 5개 정의
	...
	public LayoutTest() {
		...
		//컨테이너에 컴포넌트 연결 : add()
		//컨테이너.add(컴포넌트)
		//this.add(northBtn, "North"); //이건 실수할 확률이 높다.
		//this.add(northBtn, BorderLayout.NORTH); //North
